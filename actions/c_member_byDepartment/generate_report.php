...
/*
 * generates the report (binning users into their corresponding departments)
 */
...
// check for updates, if the members don't match up, we'll generate
if ($last_member[0]->getGUID() != $last_member_saved)
{
		global $CONFIG;
		// cyu - modified 01-14-2015: issues with table naming convention fixed
		...
		// cyu - modified 01-14-2015: debugging information, in case something goes wrong
		$connection = mysqli_connect($CONFIG->dbhost, $CONFIG->dbuser, $CONFIG->dbpass, $CONFIG->dbname);
		if (mysqli_connect_errno($connection)) error_log("cyu_generate_report.php: - Failed to connect to MySQL: ".mysqli_connect_errno());
		if (!mysqli_query($connection,$query)) error_log("cyu_generate_report.php: - Error:".mysqli_error($connection));
